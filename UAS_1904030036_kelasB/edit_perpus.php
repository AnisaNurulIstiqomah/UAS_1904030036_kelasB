                ...
                <div class="col px-3">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id_buku" value="<?= $buku['id_buku'] ?>"
                                placeholder="ID Buku" name="id_buku" autofocus required autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="judul_buku" class="form-label mt-2">Judul Buku : </label>
                            <input type="text" class="form-control" id="judul_buku" value="<?= $buku['judul_buku'] ?>"
                                placeholder="Judul Buku" name="judul_buku" required autocomplete="off">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pengarang" value="<?= $buku['pengarang'] ?>"
                                placeholder="Pengarang" name="pengarang" required autocomplete="off">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="penerbit" value="<?= $buku['penerbit'] ?>"
                                placeholder="Penerbit" name="penerbit" required autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="tahun_terbit" class="form-label mt-2">Tahun Terbit : </label>
                            <input type="text" class="form-control" id="tahun_terbit"
                                value="<?= $buku['tahun_terbit'] ?>" placeholder="Tahun Terbit" name="tahun_terbit"
                                required autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="gambar_buku" class="form-label mt-2">Upload Image :</label>
                            <input class="form-control" type="file" id="gambar_buku" value="<?= $buku['gambar_buku'] ?>"
                                placeholder="Gambar Buku" name="gambar_buku" required autocomplete="off">
                        </div>
